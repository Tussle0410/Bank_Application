...
public class remittance_history_funding_fragment extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        historyAddressCheck.execute("http://" + IP_Address + "/bank/historyAddressCheck.php",Info.getString("ID"),"funding");
